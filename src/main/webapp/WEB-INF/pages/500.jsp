						...
						<li>
							...
							<ul class="menu">
								<li><!-- start message -->
									<a href="#">
										<div class="pull-left">
											<img src="${pageContext.request.contextPath}/resources/img/avatar3.png"
								...
								<li>
									<a href="#">
										<div class="pull-left">
											<img src="${pageContext.request.contextPath}/resources/img/avatar2.png"
											     class="img-circle" alt="user image"/>
										</div>
										<h4>
					...
					<ul class="dropdown-menu">
						...
						<li>
							...
							<ul class="menu">
								...
								<li>
									<a href="#">
										<i class="fa fa-warning danger"></i> Very long description here that may not fit into
				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header bg-light-blue">
							<img src="${pageContext.request.contextPath}/resources/img/avatar3.png" class="img-circle"
							     alt="User Image"/>
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="treeview">
					...
					<ul class="treeview-menu">
						<li><a href="../forms/general.html"><i class="fa fa-angle-double-right"></i> General Elements</a>
						</li>
				...
				<li class="treeview active">
					...
					<ul class="treeview-menu">
						...
						<li class="active"><a href="500.html"><i class="fa fa-angle-double-right"></i> 500 Error</a></li>
					...
					<form class='search-form'>
						<div class='input-group'>
							...
							<div class="input-group-btn">
								<button type="submit" name="submit" class="btn btn-info"><i class="fa fa-search"></i>
								</button>
							</div>
						</div>
						<!-- /.input-group -->
