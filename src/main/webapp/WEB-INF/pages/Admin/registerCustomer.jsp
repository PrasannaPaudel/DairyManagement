...
<body>
<c:url var="addAction" value="/dairyAdmin/Customer/save"/>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <form role="form" action="${addAction}" commandName="customer" method="post">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="customerType" id="customerType">
                        </div>
