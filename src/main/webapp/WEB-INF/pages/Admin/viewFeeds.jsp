...
<body>
<c:url var="editAction" value="/dairyAdmin/mealTaken/edit"/>
...
<div id="wrapper">
	...
	<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li>
							<i class="fa fa-file"></i> Feeds Page
						</li>
					</ol>
				</div>
			</div>
				...
				<div class="col-lg-12">
					...
					<form role="form">
						...
						<div id="mydata">
							...
							<c:if test="${!empty listDairyFeeds}">
								<table class="table table-bordered table-hover table-striped" id="dairyFeeds">
										...
										<tr>
											...
											<td width="40px">
												<a href="#"
												   ...
												   data-did="${dairyFeeds.dairyId}"
												   data-cid="${dairyFeeds.cowId}"
												   data-mt="${dairyFeeds.mealType}"
												   data-q="${dairyFeeds.quantity}"
												   data-d="${dairyFeeds.date}"><i class="fa fa-bucket">Edit</i></a>
							...
							<c:if test="${empty listDairyFeeds}">
								<table id="dairyFeeds" class="table table-bordered table-hover table-striped" width="100%"
								       cellspacing="0">
									<thead>
									<tr>
										<th>Cow-Id</th>
		...
		<form:form action="${editAction}" commandName="dairyFeeds"
		           id="dairyFeeds" method="post">
						...
						<div class="modal-body" id="modalUpdateCow">
							...
							<div class="row">
								...
								<div class="col-lg-6">
									...
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user-md"></i></span>
										<input class="form-control" type="text" id="mealType" name="mealType"  />
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-lg-6">
									...
									<div class="input-group">
										<%--<span class="input-group-addon"><i class="fa fa-user-md"></i></span>--%>
										<input class="form-control" type="hidden" id="dairyId" name="dairyId"  readonly/>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-lg-4">
									<button class="btn btn-success pull-right" type="submit">
										<i
												class="fa fa-check-circle-o"></i> Edit
									</button>
								</div>
								<div class="col-lg-4">
