...
<head>
	...
	<script type="text/javascript"
	        src="${pageContext.request.contextPath}/resources/js/modal/jquery-1.9.1.min.js"></script>
	...
	<div id="page-wrapper">
		...
		<div class="container-fluid">
			...
			<div id="loginmodal" style="display:none;">
				...
				<form id="loginform" name="loginform" method="post" action="${updateAction}"
				      commandName="cowRegistration">
					...
					<div class="center"><input type="submit" name="loginbtn" id="loginbtn" class="flatbtn-blu hidemodal"
					                           value="Log In" tabindex="3"></div>
				</form>
			</div>
								...
								<c:forEach items="${listCows}" var="dairyCows">
									<tr>
										...
										<td width="40px">
											...
											<a href="#loginmodal" class="btn btn-sm btn-danger"
											   id="modaltrigger">load</a>
										</td>
