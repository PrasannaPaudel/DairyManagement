			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li>
							<i class="fa fa-file"></i> Customer Page
						</li>
					</ol>
				</div>
			</div>
					...
					<form role="form">
						...
						<div id="mydata">
							...
							<c:if test="${!empty listCustomer}">
								<table class="table table-bordered table-hover table-striped" id="customer">
									...
									<c:forEach items="${listCustomer}" var="customer">
										<tr>
											...
											<td width="40px">
												<a href="<c:url value="/dairyAdmin/Customer/remove/${customer.customerId}"/>"
							...
							<c:if test="${empty listCustomer}">
								<table id="customer" class="table table-bordered table-hover table-striped" width="100%"
								       cellspacing="0">
									<thead>
									<tr>
										<th>Customer-Name</th>
