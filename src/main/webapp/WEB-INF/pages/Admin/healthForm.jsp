...
<c:url var="addAction" value="/dairyAdmin/CowHealth/save"/>
				...
				<form role="form" action="${addAction}" commandName="health" method="post">
					<div class="col-lg-6">
						...
						<div class="form-group">
							...
							<input class="form-control" name="diseaseType" id="diseaseType">
						</div>

						<div class="form-group">
							<label>Symptoms</label>
							<input class="form-control" name="symptoms" id="symptoms">
						</div>
					...
					<div class="col-lg-6">
						...
						<div class="form-group">
							...
							<input class="form-control" name="medicine" id="medicine">
						</div>

						<div class="form-group">
							<label>Treatment Cost</label>
							<input class="form-control" name="treatmentCost" id="treatmentCost">
						</div>
