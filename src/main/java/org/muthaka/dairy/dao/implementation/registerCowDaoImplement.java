...
@Repository public class registerCowDaoImplement implements registerCowDao {
	...
	@Override public void updateCow(CowRegistration cowReg) {
	...
	@Override public CowRegistration getCowById(Integer cowId) {
		Session session = this.sessionFactory.getCurrentSession();
		try {
	...
	@Override public CowRegistration getCowByUuid(Integer cowUuid) {
		Session session = this.sessionFactory.getCurrentSession();
		try {
