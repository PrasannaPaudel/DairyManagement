...
@Repository public class mealDaoImplement implements mealDao {
	...
	@Override public void addFeeds(DairyFeeds dairyfeeds) {
	...
	@Override public void updateFeeds(DairyFeeds dairyfeeds) {
		Session session = this.sessionFactory.getCurrentSession();
		try {
	...
	@Override public List<DairyFeeds> listDairyFeeds() {
		Session session = this.sessionFactory.getCurrentSession();
		try {
	...
	@Override public DairyFeeds getFeedsById(Integer dairyId) {
		Session session = this.sessionFactory.getCurrentSession();
		try {
