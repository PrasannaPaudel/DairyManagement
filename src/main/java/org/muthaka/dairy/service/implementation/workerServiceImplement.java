...
public class workerServiceImplement implements WorkerService {
	...
	@Override @Transactional public void updateWorker(Workers worker) {
	...
	@Override @Transactional public Workers getWorkerById(Integer healthId) {
		return this.workersDAO.getWorkerById(healthId);
	}

	@Override @Transactional public Workers getWorkerByUuid(Integer healthUuid) {
		return this.workersDAO.getWorkerByUuid(healthUuid);
	}

	@Override @Transactional public void removeWorker(Workers worker) {
