            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <i class="fa fa-file"></i> Milk Page
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <form role="form">
                        ...
                        <div id="mydata">
                            ...
                            <c:if test="${!empty listMilkProduced}">
                                <table class="table table-bordered table-hover table-striped" id="milkProduced">
                            ...
                            <c:if test="${empty listMilkProduced}">
                                <table id="milkProduced" class="table table-bordered table-hover table-striped" width="100%"
                                       cellspacing="0">
                                    <thead>
                                    <tr>
                                        <th>Cow-Id</th>
