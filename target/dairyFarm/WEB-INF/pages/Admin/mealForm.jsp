...
<head>
  ...
  <![endif]-->
    ...
    <c:url var="addAction" value="/dairyAdmin/mealTaken/save"/>
      ...
      <!-- /.row -->
        ...
        <div class="row">
            <div class="col-lg-6" id="myform">
                ...
                <form role="form" action="${addAction}" commandName="dairyFeeds" method="post">
                    ...
                    <button   class="fa fa-plus-square" id="addTable"  onclick="Javascript:addMeal()">Add</button>
