	...
	<script type="text/javascript">
		$(document).ready(function () {
			$(".cowUpdate").click(function () { // Click to only happen on announce links
				$("#dairyId").val($(this).data('did'));
				$("#cowId").val($(this).data('cid'));
				$("#mealType").val($(this).data('mt'));
				$("#quantity").val($(this).data('q'));
...
<c:url var="editAction" value="/dairyAdmin/CowHealth/edit"/>
...
<div id="wrapper">
	...
	<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li>
							<i class="fa fa-file"></i> Health Page
						</li>
					</ol>
				</div>
			</div>
				...
				<div class="col-lg-12">
					...
					<form role="form">
						...
						<div id="mydata">
							...
							<br/>
							<c:if test="${!empty listHealth}">
								<table class="table table-bordered table-hover table-striped" id="health">
									...
									<tbody>
									<c:forEach items="${listHealth}" var="health">
										<tr>

											<td>${health.cowId}</td>
											<td>${health.diseaseType}</td>
											<td>${health.symptoms}</td>
											<td>${health.medicine}</td>
											<td>${health.treatmentCost}</td>
											<td>${health.date}</td>
											<td width="40px">
												<a href="#"
												   class="btn btn-danger btn-sm cowUpdate " data-toggle="tooltip"
												   data-placement="top" title="Edit"
												   data-hid="${health.healthId}"
												   data-cid="${health.cowId}"
												   data-dt="${health.diseaseType}"
												   data-s="${health.symptoms}"
												   data-m="${health.medicine}"
												   data-tc="${health.treatmentCost}"
												   data-h="${health.date}"><i class="fa fa-bucket">Edit</i></a>
							...
							<c:if test="${empty listHealth}">
								<table id="health" class="table table-bordered table-hover table-striped" width="100%"
								       cellspacing="0">
									<thead>
									<tr>
										<th>Cow-Id</th>
		...
		<form:form action="${editAction}" commandName="health"
		           id="health" method="post">
						...
						<div class="modal-body" id="modalUpdateCow">
							<div class="row">
								...
								<div class="col-lg-6">
									...
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user-md"></i></span>
										<input class="form-control" type="text" id="diseaseType" name="diseaseType"  />
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-lg-6">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="symptoms" name="symptoms" readonly/>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-lg-6">
									...
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user-md"></i></span>
										<input class="form-control" type="text" id="treatmentCost" name="treatmentCost" />
									</div>
								</div>

								<div class="col-lg-6">
									<label>Date of Sickness :</label>
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<div class="input-group">
											<%--<span class="input-group-addon"><i class="fa fa-user"></i></span>--%>
										<input class="form-control" type="hidden" id="healthId" name="healthId" />
									</div>
								</div>
							</div>
